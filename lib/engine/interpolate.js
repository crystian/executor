...
const interpolateConfigVariables = (config) => {
	...
	// to template
	interpolateVariablesRecursive(newTemplates, environments);
	interpolateVariablesRecursive(newTemplates, { predefined });
	interpolateVariablesRecursive(newTemplates, newTemplates); // yes to itself!
	// to shortcuts
	interpolateVariablesRecursive(newShortcuts, environments);
	interpolateVariablesRecursive(newShortcuts, { predefined });
