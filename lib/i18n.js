...
module.exports.messages = {
	...
	errors: {
		...
		config: {
			notFound: { code: 404,	msg: 'Configuration not found. (https://github.com/crystian/executor)' },
			notConfigurationOnFile: { code: 40,	msg: 'Configuration not found on "${file}.json"' },
		...
		templates: {
			...
			invalidFormat: { code: 72,	msg: 'Invalid format, remember should be a pair key value \(both should be strings\), key: "${key}"' }, // eslint-disable-line no-useless-escape
		}
	},
	builder: {
		command: {
