...
const messages = {
	...
	config: {
		notFound: '"${fileName}" not found on this folder',
	...
	templates: {
		...
		invalidFormat: 'Invalid format, remember should be a pair key value \(both should be strings\), key: "${key}"'
	},
	shortcuts: {
	...
	shortcut: {
		...
		withoutNextArgument: '"${key}" needs a next one:',
